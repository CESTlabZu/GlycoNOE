%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% ABLATION DENOISING NETWORK ARCHITECTURE
%
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function net = abation_NN_DN(minLength, filterSize, numFilters)
    ...
    autoenc = [
        ...
        convolution1dLayer(filterSize, 1, "Padding","same","Name","finalConv1")
