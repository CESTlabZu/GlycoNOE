function [FitResult,fitParam] = pvof(k, input, fitParam)
    ...
    [FitResult.Coefficents,resnorm]=lsqcurvefit(@VoigtFunction_background,x0_background,k_background,input_background,lb,ub,options,fitParam);
    FitResult.Background = VoigtFunction_background(FitResult.Coefficents,FitResult.xindex,fitParam);
...
%     x0 = [0.1, 1, 0, 0,0,0,0];
    ...
    [FitResult.Coefficents,resnorm]=lsqcurvefit(@VoigtFunction,x0,k(45:85),input(45:85),lb,ub,options,fitParam);
    FitResult.Coefficents3=FitResult.Coefficents;
    FitResult.Curve = VoigtFunction(FitResult.Coefficents,FitResult.xindex,fitParam);
